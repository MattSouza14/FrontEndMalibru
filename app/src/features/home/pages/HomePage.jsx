...
import ExpiringPanel, { DateCell, ExpiryStatusCell } from '../../../shared/components/ExpiringPanel.jsx';
...
import { ExpiryProgressBar } from '../../../shared/ui/ProgressBar.jsx';
import { listCertificates } from '../../licenses/services/certificateService.js';
import { listAdminChamados } from '../../support/services/chamadoService.js';
import { listOfficeLicenses } from '../../licenses/services/officeLicenseService.js';
import { listSoftwareLicenses, listSoftwareLicensesByUser } from '../../licenses/services/softwareLicenseService.js';
import { getMyEquipments, getMyOfficeLicense, getMySoftwareLicenses } from '../../users/services/userResourcesService.js';
import { formatEmpresaLabel } from '../../inventory/utils/equipment.js';
import { daysUntil, expiryBadgeClass, expiryLabel, formatDate, getTopExpiring } from '../../../shared/lib/expiry.js';
import { clampPageAfterChange, paginateItems } from '../../../shared/lib/pagination.js';
import {
